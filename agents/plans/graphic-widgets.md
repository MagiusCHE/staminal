...
- [ ] Creare `widget.rs` in `stam_mod_runtimes/src/api/graphic/`
  ...
  - [ ] `SizeValue`, `EdgeInsets`, `ColorValue` (tipi comuni)
...
- [ ] Gestione automatica colori button
...
- [ ] Background color opzionale

#### 4.2 Text Widget
- [ ] Content, fontSize, fontColor
- [ ] TextAlign
- [ ] Update dinamico content

#### 4.3 Button Widget
- [ ] Label, fontSize
- [ ] Colori: normal, hover, pressed
- [ ] Disabled state
...
#### 4.5 Image Widget (Fase successiva)
